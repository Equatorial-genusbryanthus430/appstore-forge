...
export const TEMPLATES: TemplateSpec[] = [
  ...
  },
  {
    ...
    label: 'Notebook',
    description:
      'Warm paper tones, a big left-aligned headline with marker highlights, and a phone that runs off the bottom. Alternates colour and tilt across the set.',
    settings: {
    ...
    variants: [
      {
        ...
        backdropColor: '#ebe5d6',
        positionId: 'center',
        highlights: ['#e9c7c2', '#cfdbc1'],
      },
      {
        background: { kind: 'solid', color: '#f6eee5' },
        backdropColor: '#e8d8c3',
        positionId: 'tilted',
        highlights: ['#efcfb9', '#cfdbc1'],
      },
      {
        background: { kind: 'solid', color: '#efeadb' },
        backdropColor: null,
        positionId: 'offset',
        highlights: ['#e9c7c2', '#cfdbc1'],
      },
      {
        background: { kind: 'solid', color: '#ecd7d8' },
        backdropColor: '#e3c6c8',
        positionId: 'tilted',
        highlights: ['#f0d5c4', '#cfdbc1'],
      },
      {
        background: { kind: 'solid', color: '#f3efe4' },
        backdropColor: '#d6e0cd',
        positionId: 'center',
        highlights: ['#cfdbc1', '#e9c7c2'],
      },
    ],
    samples: [
      { headline: 'The list that *feels* like a *notebook.*', subhead: '' },
      {
        headline: 'Hands full? *Just say it.*',
        subhead: 'Tap once. Talk. Multiple items, quantities, brands — all in one breath.',
      },
      { headline: 'Turn pictures *into text*', subhead: '' },
      {
        headline: 'Import recipes from *apps* & websites',
        subhead: 'Bring recipes in from the places you already save them.',
      },
...
export const getTemplateSpec = (id: string): TemplateSpec =>
